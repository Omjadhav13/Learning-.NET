...
namespace LearningLINQ
{
    ...
    public class Department
    {
        ...
        static void Main(string[] args)
        {
            ...
            var empss = from emp in lstEmp where emp.Basic > 10000 orderby emp.Name select emp;

            var jo = from emp in lstEmp join dept in lstDept on emp.DeptNo equals dept.DeptNo select new { emp.Name, emp.EmpNo, dept.DeptNo };
